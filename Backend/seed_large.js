const { sequelize, Auto, Dolgozo, Ugyfel, Foglalas } = require('./models');
...
async function run() {
    try {
        ...
        await seedTable(Dolgozo, () => {
            ...
            return {
                nev: fullName,
                jelszo: 'jelszo123', // constant for testing
        ...
        await seedTable(Ugyfel, () => {
            ...
            // Generate email based on name (basic slugify)
            ...
            return {
                ...
                Email: email,
                igSzam: getRandomInt(100000, 999999) + getRandomItem(['AA', 'BA', 'CA', 'DA']), // simplified format
        ...
        await seedTable(Foglalas, () => {
            ...
            // End date 1-14 days after start
            ...
            return {
                ...
                Ar: getRandomInt(5000, 30000) * getRandomInt(1, 14), // daily rate * days roughly
