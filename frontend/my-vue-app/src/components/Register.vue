  ...
  methods: {
    async handleRegister() {
      ...
      try {
        ...
        if (response.ok) {
          this.message = 'Sikeres regisztráció! Automatikusan bejelentkezés...';
          this.isError = false;
          ...
          localStorage.setItem('nev', this.nev); // Store username for display

          // Open oldal2.html in a new tab after successful registration
          setTimeout(() => {
